    ...
    <div v-if="index2 == 0">
      ...
      >
        ...
        <div
          ...
          "
        ></div>
        <div v-if="value[i-1] == 'input'" style="color: grey; margin-top: 20px">
          待填写者写入文本
        </div>

        <div
          v-if="value[i-1] == 'InputNumber'"
        ...
        <div
          ...
          style="color: grey; margin-top: 20px"
        >
          <div v-for="j in radionum[i-1]" :id="j" :key="j">
            ○
            <el-input
              placeholder="请输入选项名"
          ...
          <div>
            <el-button type="text" @click="addradio(i-1)"
              ><i
                class="el-icon-circle-plus-outline"
                style="font-size: 20px; margin-top: 10px"
              ></i
            ></el-button>
            <el-button type="text" @click="deleteradio(i-1)"
              ><i
        ...
        <div
          ...
          style="color: grey; margin-top: 20px"
        >
          <div v-for="j in checkboxnum[i-1]" :id="j" :key="j">
            □
            <el-input
              placeholder="请输入选项名"
          ...
          <div>
            <el-button type="text" @click="addcheckbox(i-1)"
              ><i
                class="el-icon-circle-plus-outline"
                style="font-size: 20px; margin-top: 10px"
              ></i
            ></el-button>
            <el-button type="text" @click="deletecheckbox(i-1)"
              ><i
                class="el-icon-remove-outline"
                style="font-size: 20px; margin-top: 10px"
              ></i
        ...
        <div
          ...
          style="color: grey; margin-top: 20px"
        >
          <div v-for="j in selectnum[i-1]" :id="j" :key="j">
            {{ j }}
            <el-input
              placeholder="请输入选项名"
          ...
          <div>
            <el-button type="text" @click="addselect(i-1)"
              ><i
                class="el-icon-circle-plus-outline"
                style="font-size: 20px; margin-top: 10px"
              ></i
            ></el-button>
            <el-button type="text" @click="deleteselect(i-1)"
              ><i
                class="el-icon-remove-outline"
                style="font-size: 20px; margin-top: 10px"
              ></i
